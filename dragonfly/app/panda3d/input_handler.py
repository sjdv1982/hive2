...
keyboard_mapping = {'lcontrol': 'left_control', 'lshift': 'left_shift', 'ralt': 'right_alt', 'rcontrol': 'right_control',
                   ...
                   'arrow_up': 'arrow_up', 'arrow_down': 'arrow_down', 'arrow_left': 'arrow_left', 'control': 'control',
                   'arrow_right': 'arrow_right', 'alt': 'alt'}

keyboard_mapping.update(zip(string.digits, string.digits))
