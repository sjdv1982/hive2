...
d = dragonfly.io.Print()
print(d._pprint.value_in._hive_bee_name)
# # from test.bge_project.aphidimp import Aphidimp as A
# #
# # import dragonfly
# # import hive
# #
# #
# # def build(i, ex, args):
# #     i.events = dragonfly.event.EventHive()
# #     i.h = A()
# #
# #
# # X = hive.hive("X", build)
# # a= X()
# # a._events.event_in.push(('start',))
# #
# #
# #
# # # import string
...
#
# model.setHorizontalHeaderLabels(("Bee", "Operation", "Value"))
# for col in range(3):
#     for row in range(3):
#         model.setItem(row, col, QStandardItem("HI"))
#
