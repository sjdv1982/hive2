def add_print_complex(node_manager, format_string):
    format_node = node_manager.create_hive("dragonfly.string.Format", params={'meta_args':
                                                                                  {'format_string': format_string}
                                                                              })
    transistor_node = node_manager.create_hive("dragonfly.std.Transistor", params={'meta_args': {'data_type': 'str'}})
    print_node = node_manager.create_hive("dragonfly.io.Print")
